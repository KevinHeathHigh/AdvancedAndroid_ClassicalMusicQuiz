...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // TODO/COMPLETED (1): Create a method that shows a MediaStyle notification
    // with two actions (play/pause, skip to previous).
    ...
    private void showNotification(PlaybackStateCompat state) {
        ...
        PendingIntent contentPendingIntent = PendingIntent
                .getActivity(this, 0, new Intent(this, QuizActivity.class), 0);
