...
public class QuizActivity extends AppCompatActivity implements View.OnClickListener, ExoPlayer.EventListener {
    ...
    // TODO/COMPLETED (1): Create a method to initialize the MediaSession.
    ...
    // TODO/COMPLETED (2): Create an inner class that extends MediaSessionCompat.Callbacks,
    // and override the onPlay(), onPause(), and onSkipToPrevious() callbacks.
    // Pass an instance of this class into the MediaSession.setCallback()
    // method in the method you created in TODO 1.
    ...
    protected void onDestroy() {
        // TODO/COMPLETED (4): When the activity is destroyed, set the MediaSession to inactive.
        super.onDestroy();
    ...
    public void onPlayerStateChanged(boolean playWhenReady, int playbackState) {
        if((playbackState == ExoPlayer.STATE_READY) && playWhenReady){
            // TODO/COMPLETED (3): When ExoPlayer is playing, update the PlayBackState.
            Log.d(TAG, "onPlayerStateChanged: PLAYING");
            mStateBuilder.setState(PlaybackStateCompat.STATE_PLAYING,
                    mExoPlayer.getCurrentPosition(), 1f);
        } else if ((playbackState == ExoPlayer.STATE_READY)) {
            // TODO/COMPLETED (3): When ExoPlayer is paused, update the PlayBackState.
